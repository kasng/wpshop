						...
						<div class="row">
							<div class="large-12 columns">
								...
								<div class="copyright_text">
									<?php if ( !empty( Shopkeeper_Opt::getOption( 'footer_copyright_text', esc_html__('Powered by ', 'shopkeeper' ) . '<a href="https://shopkeeper.getbowtied.com" title="eCommerce WordPress Theme for Woocommerce">' . esc_html__( 'Shopkeeper', 'shopkeeper' ) . '</a>.' ) ) ) { ?>
										<?php printf( wp_kses_post(__( '%s', 'shopkeeper' )), Shopkeeper_Opt::getOption( 'footer_copyright_text', esc_html__('Powered by ', 'shopkeeper' ) . '<a href="https://shopkeeper.getbowtied.com" title="eCommerce WordPress Theme for Woocommerce">' . esc_html__( 'Shopkeeper', 'shopkeeper' ) . '</a>.' )); ?>
									<?php } ?>
								</div><!-- .copyright_text -->
