	...
	class GBT_Ajax_Search {
		...
		public function getbowtied_scripts() {
			...
			if ( !is_admin() ) {
				...
				wp_enqueue_script( 'getbowtied-predictive-search-script', get_template_directory_uri() . '/inc/search/assets/js/search'.$suffix.'.js', array( 'jquery' ), shopkeeper_theme_version(), true );
