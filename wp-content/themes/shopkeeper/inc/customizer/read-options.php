...
class Shopkeeper_Opt {
	...
	private static function theme_defaults() {
		...
		return [
        	...
        	'footer_copyright_text' 					=> esc_html__('Powered by ', 'shopkeeper' ) . '<a href="https://shopkeeper.getbowtied.com" title="eCommerce WordPress Theme for Woocommerce">' . esc_html__( 'Shopkeeper', 'shopkeeper' ) . '</a>.',
