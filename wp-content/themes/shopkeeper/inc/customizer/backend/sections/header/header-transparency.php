	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			array(
                ...
                'description' => '<span class="dashicons dashicons-editor-help"></span><a target="_blank" href="https://shopkeeper.wp-theme.help/hc/en-us/articles/206678899">' . esc_html__( 'Working with Header Transparency', 'shopkeeper' ) . '</a>',
				'priority' => 10,
			)
		)
	);
