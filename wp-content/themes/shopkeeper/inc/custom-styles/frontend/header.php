...
$custom_styles .= '
	...
	@media only screen and (min-width: 1024px) and (max-width: 1201px)
	{
		...
		body.single-product #page_wrapper.sticky_header .content-area
		{
			padding-top: calc(' . $content_margin . 'px + 25px);
		}
	}';
...
if( ( !Shopkeeper_Opt::getOption( 'main_header_wishlist', true ) || !SHOPKEEPER_WISHLIST_IS_ACTIVE ) && !Shopkeeper_Opt::getOption( 'main_header_shopping_bag', true ) &&
...
if( Shopkeeper_Opt::getOption( 'main_header_layout', '1' ) == "2" || Shopkeeper_Opt::getOption( 'main_header_layout', '1' ) == "22" ) {
	...
	if ( SHOPKEEPER_WISHLIST_IS_ACTIVE && Shopkeeper_Opt::getOption( 'main_header_wishlist', true ) ) $header_col_right_menu_right_padding += 60;
...
if ( Shopkeeper_Opt::getOption( 'main_header_shopping_bag_icon', '' ) != "" ) {
	$custom_styles .= '
